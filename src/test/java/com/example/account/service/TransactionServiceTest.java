...
class TransactionServiceTest {
    ...
    @Mock
    private AccountUserRepository acccountUserRepository;
    ...
    void successUseBalance() {
        ...
        given(acccountUserRepository.findById(anyLong()))
    ...
    void deletAccount_AccountNotFound() {
        //given
        AccountUser user = AccountUser.builder()
                .name("Pobi").build();
        user.setId(12L);
    ...
    void successCancelBalance() {
        ...
        //when
        TransactionDto transactionDto = transactionService.cancelBalance("transactioinId",
